---
title: "웹 접근성: 스크린 리더와 색상 대비율에 대하여"
date: "2025-11-24"
description: "Lighthouse 접근성 검사에서 발견된 스크린 리더 문제와 색상 대비율 이슈를 해결한 경험을 정리합니다."
---

이번 글에서는 Lighthouse 접근성 검사 결과, 버튼 접근성과 색상 대비율 문제가 발견되어 해결해나가는 과정을 정리합니다.
...
```tsx
<SelectTrigger aria-label="희망 포지션 선택">
...
// Before
const badgeThemes = {
  green: "bg-green-300/10 text-green-600",
  blue: "bg-blue-300/10 text-blue-600",
  red: "bg-red-300/10 text-red-600",
...
- Lighthouse 접근성 89점 → 100점
- 주요 UI 요소가 스크린 리더와 저시력 사용자에게 더 명확하게 전달
