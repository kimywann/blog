...
개선 전 모바일 화면에서는 **사이드바가 화면의 절반 넘게 차지**하여 등록된 프로필을 확인하기엔 문제가 있고 개선 여지가 필요했습니다.

또 하나의 문제는 **내 프로필 접근성**이었습니다. 프로필이 **생성 순으로 정렬**되다 보니, 등록자가 많아질수록 **내 프로필을 찾기가 점점 어려워졌습니다**. 내 프로필을 확인하려면 목록을 스크롤하거나 수정 버튼으로만 접근할 수 있었습니다.
